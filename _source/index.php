	...
	/*
		...
		\______   \__ __  _____/ ____\__| _____|  |__  
		 ...
		 |______  /____/\___  /|__|  |__/____  >___|  /
				\/     /_____/               \/     \/  Index File for Mail Relaying over DNS */
	# Include Settings
...
<html version="-//W3C//DTD XHTML 1.1//EN"
  ...
  <head>
	<!-- Meta Tags For Site --> 
	<title><?php echo _TITLE_; ?> | MRoD by Bugfish</title>	 
	<!-- Meta Tags For Site -->
  ...
  <body><div id="contentwrapper"></div><div id="content">
	<?php if($user->user_loggedIn) { $permsobj = new x_class_perm($mysql, _TABLE_PERM_, "mrod");?>
	<div id="nav">
		...
		<?php if($permsobj->hasPerm($user->user_id, "relay") OR $user->user_rank == 0 OR $permsobj->hasPerm($user->user_id, "relay_own")) { ?><a href="./?site=relay" <?php if(@$_GET["site"] == "relay") { echo 'id="nav_active"'; } ?>>Relays</a> - <?php } ?>
...
<?php } 
	...
	if($user->loggedIn) {			
		switch(@$_GET["site"]) {
			...
			case "relay": require_once("./_instance/site_relay.php"); break;
			case "domains": require_once("./_instance/site_domains.php"); break;
			case "domains": require_once("./_instance/site_domainsusr.php"); break;
			case "domains": require_once("./_instance/site_domainsbnd.php"); break;
